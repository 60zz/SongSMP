...
import net.mcreator.vlabyss.item.WindSwordItem;
import net.mcreator.vlabyss.item.WildernesBannerPatternItem;
import net.mcreator.vlabyss.item.VotoSilenciosoItem;
import net.mcreator.vlabyss.item.VesperianDaggerItem;
import net.mcreator.vlabyss.item.VelmorraBannerPatternItem;
import net.mcreator.vlabyss.item.SwordOfPureProtectorItem;
import net.mcreator.vlabyss.item.StoneHeartItem;
import net.mcreator.vlabyss.item.SpiritFlowPotionItem;
import net.mcreator.vlabyss.item.SpearOfImperatorItem;
import net.mcreator.vlabyss.item.SoulSlayerItem;
import net.mcreator.vlabyss.item.SnowstormSwordItem;
import net.mcreator.vlabyss.item.SkullCrusherItem;
import net.mcreator.vlabyss.item.SeletorClassesItem;
import net.mcreator.vlabyss.item.RunasItem;
import net.mcreator.vlabyss.item.RedDeathItem;
import net.mcreator.vlabyss.item.RedBladeItem;
import net.mcreator.vlabyss.item.RawAbyssionItem;
import net.mcreator.vlabyss.item.PurpleScytheItem;
...
import net.mcreator.vlabyss.item.NyvathBannerPatternItem;
import net.mcreator.vlabyss.item.NoctharisBannerPatternItem;
...
import net.mcreator.vlabyss.item.LightningSwordItem;
import net.mcreator.vlabyss.item.LightSwordItem;
import net.mcreator.vlabyss.item.LiberacaoMantraItem;
import net.mcreator.vlabyss.item.InfinityEssencePotionItem;
import net.mcreator.vlabyss.item.HerosBladeItem;
import net.mcreator.vlabyss.item.FragmentoPrimordialItem;
import net.mcreator.vlabyss.item.FlameSwordItem;
...
import net.mcreator.vlabyss.item.DepthsBannerPatternItem;
import net.mcreator.vlabyss.item.DarknessSwordItem;
import net.mcreator.vlabyss.item.CrimsonDemonItem;
import net.mcreator.vlabyss.item.ColdHuntressItem;
import net.mcreator.vlabyss.item.CintoDosEcosItem;
import net.mcreator.vlabyss.item.CarvedSwordItem;
import net.mcreator.vlabyss.item.CapuzEsquecidoItem;
import net.mcreator.vlabyss.item.BotasVazioAbyssalItem;
import net.mcreator.vlabyss.item.BloodingScytheItem;
import net.mcreator.vlabyss.item.AxeOfAngelItem;
import net.mcreator.vlabyss.item.AstralAxeItem;
import net.mcreator.vlabyss.item.ArtifactsBundleItem;
import net.mcreator.vlabyss.item.ArcaneStrengthPotionItem;
...
import net.mcreator.vlabyss.item.AbyssionDaggerItem;
import net.mcreator.vlabyss.item.AbyssBannerPatternItem;
...
public class VlAbyssModItems {
	...
	public static final RegistryObject<Item> INFINITY_ESSENCE_POTION = REGISTRY.register("infinity_essence_potion", () -> new InfinityEssencePotionItem());
	public static final RegistryObject<Item> ARCANE_STRENGTH_POTION = REGISTRY.register("arcane_strength_potion", () -> new ArcaneStrengthPotionItem());
	public static final RegistryObject<Item> SPIRIT_FLOW_POTION = REGISTRY.register("spirit_flow_potion", () -> new SpiritFlowPotionItem());
	public static final RegistryObject<Item> SELETOR_CLASSES = REGISTRY.register("seletor_classes", () -> new SeletorClassesItem());
	public static final RegistryObject<Item> ABYSS_BANNER_PATTERN = REGISTRY.register("abyss_banner_pattern", () -> new AbyssBannerPatternItem());
	public static final RegistryObject<Item> DEPTHS_BANNER_PATTERN = REGISTRY.register("depths_banner_pattern", () -> new DepthsBannerPatternItem());
	public static final RegistryObject<Item> WILDERNES_BANNER_PATTERN = REGISTRY.register("wildernes_banner_pattern", () -> new WildernesBannerPatternItem());
	public static final RegistryObject<Item> NYVATH_BANNER_PATTERN = REGISTRY.register("nyvath_banner_pattern", () -> new NyvathBannerPatternItem());
	public static final RegistryObject<Item> NOCTHARIS_BANNER_PATTERN = REGISTRY.register("noctharis_banner_pattern", () -> new NoctharisBannerPatternItem());
	public static final RegistryObject<Item> VELMORRA_BANNER_PATTERN = REGISTRY.register("velmorra_banner_pattern", () -> new VelmorraBannerPatternItem());
	public static final RegistryObject<Item> STONE_HEART = REGISTRY.register("stone_heart", () -> new StoneHeartItem());
	public static final RegistryObject<Item> ASTRAL_AXE = REGISTRY.register("astral_axe", () -> new AstralAxeItem());
	public static final RegistryObject<Item> BLOODING_SCYTHE = REGISTRY.register("blooding_scythe", () -> new BloodingScytheItem());
	public static final RegistryObject<Item> AXE_OF_ANGEL = REGISTRY.register("axe_of_angel", () -> new AxeOfAngelItem());
	public static final RegistryObject<Item> SPEAR_OF_IMPERATOR = REGISTRY.register("spear_of_imperator", () -> new SpearOfImperatorItem());
	public static final RegistryObject<Item> SKULL_CRUSHER = REGISTRY.register("skull_crusher", () -> new SkullCrusherItem());
	public static final RegistryObject<Item> RED_DEATH = REGISTRY.register("red_death", () -> new RedDeathItem());
	public static final RegistryObject<Item> SWORD_OF_PURE_PROTECTOR = REGISTRY.register("sword_of_pure_protector", () -> new SwordOfPureProtectorItem());
	public static final RegistryObject<Item> RED_BLADE = REGISTRY.register("red_blade", () -> new RedBladeItem());
	public static final RegistryObject<Item> HEROS_BLADE = REGISTRY.register("heros_blade", () -> new HerosBladeItem());
	public static final RegistryObject<Item> ADAGA_ASSASSINOS = REGISTRY.register("adaga_assassinos", () -> new AdagaAssassinosItem());
	public static final RegistryObject<Item> ABYSSION_DAGGER = REGISTRY.register("abyssion_dagger", () -> new AbyssionDaggerItem());
	public static final RegistryObject<Item> VESPERIAN_DAGGER = REGISTRY.register("vesperian_dagger", () -> new VesperianDaggerItem());
	public static final RegistryObject<Item> COLD_HUNTRESS = REGISTRY.register("cold_huntress", () -> new ColdHuntressItem());
	public static final RegistryObject<Item> CARVED_SWORD = REGISTRY.register("carved_sword", () -> new CarvedSwordItem());
	public static final RegistryObject<Item> SOUL_SLAYER = REGISTRY.register("soul_slayer", () -> new SoulSlayerItem());
	...
	public static final RegistryObject<Item> SNOWSTORM_SWORD = REGISTRY.register("snowstorm_sword", () -> new SnowstormSwordItem());
	public static final RegistryObject<Item> LIGHT_SWORD = REGISTRY.register("light_sword", () -> new LightSwordItem());
	public static final RegistryObject<Item> PURPLE_SCYTHE = REGISTRY.register("purple_scythe", () -> new PurpleScytheItem());
	public static final RegistryObject<Item> CRIMSON_DEMON = REGISTRY.register("crimson_demon", () -> new CrimsonDemonItem());
