...
public class VlAbyssModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == VlAbyssModVillagerProfessions.AVENTUREIRO_PROFESSION.get()) {
			...
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(VlAbyssModItems.ABYSSION_INGOT.get(), 8), new ItemStack(Items.NETHERITE_INGOT, 24), new ItemStack(VlAbyssModItems.DESBLOQUEIO_ESQUIVA.get()), 5, 30, 0.05f));
		}
