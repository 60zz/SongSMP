...
public class ConfiguraSolLuaProcedure {
	public static abstract class VlAbyssModDimensionSpecialEffects extends DimensionSpecialEffects {
		...
		public VlAbyssModDimensionSpecialEffects(float cloudHeight, boolean hasGround, DimensionSpecialEffects.SkyType skyType, boolean forceBrightLightmap, boolean constantAmbientLight) {
	...
	public static void register(String name, DimensionSpecialEffects effects) {
		provider.register(new ResourceLocation("vl_abyss", name), effects);
	}
	...
	public static DimensionSpecialEffects createOverworldEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new VlAbyssModDimensionSpecialEffects(192.0F, true, DimensionSpecialEffects.SkyType.NORMAL, constantWhiteLight, constantAmbientLight) {
			@Override
	...
	public static DimensionSpecialEffects createNetherEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new VlAbyssModDimensionSpecialEffects(Float.NaN, true, DimensionSpecialEffects.SkyType.NONE, constantWhiteLight, constantAmbientLight) {
			@Override
			public Vec3 getBrightnessDependentFogColor(Vec3 color, float sunHeight) {
				return color;
			}
	...
	public static DimensionSpecialEffects createEndEffects(final boolean constantWhiteLight, final boolean constantAmbientLight, final boolean fog) {
		return new VlAbyssModDimensionSpecialEffects(Float.NaN, false, DimensionSpecialEffects.SkyType.END, constantWhiteLight, constantAmbientLight) {
			@Override
			public Vec3 getBrightnessDependentFogColor(Vec3 color, float sunHeight) {
	...
	private static void execute(@Nullable Event event) {
		...
		register(ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("vl_abyss:abismo")), createOverworldEffects(false, false, false));
	}
}