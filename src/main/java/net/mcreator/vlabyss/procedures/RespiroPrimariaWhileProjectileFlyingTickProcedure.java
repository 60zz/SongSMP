...
if (!(entityiterator instanceof MantraSoulEntity)||!(entityiterator instanceof RespiroPrimariaEntity)) {if (!( == entityiterator)) {entityiterator.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.parse("vl_abyss:mantra_damage")))), (float));}}
}
}world.addParticle((SimpleParticleType) (VlAbyssModParticleTypes.VENTO_PARTICULA_1.get()), x, y, z, 0, 0, 0);world.addParticle((SimpleParticleType) (VlAbyssModParticleTypes.VENTO_PARTICULA_2.get()), (x+Mth.nextDouble(RandomSource.create(), -1, 1)), (y-Mth.nextDouble(RandomSource.create(), 0.1, 1)), (z+Mth.nextDouble(RandomSource.create(), -1, 1)), 0, 0, 0);if (Math.random()>=0.9) {if (world instanceof ServerLevel _level) {
LightningBolt entityToSpawn = EntityType.LIGHTNING_BOLT.create(_level);
entityToSpawn.moveTo(Vec3.atBottomCenterOf(BlockPos.containing(x,y,z)));
entityToSpawn.setVisualOnly(true);
_level.addFreshEntity(entityToSpawn);
}}immediatesourceentity.setNoGravity(true);VlAbyssMod.queueServerWork(40, () -> {
