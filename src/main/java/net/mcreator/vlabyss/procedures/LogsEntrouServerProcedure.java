...
public class LogsEntrouServerProcedure {
    ...
    private static void execute(@Nullable Event event) {
        if (event instanceof PlayerEvent.PlayerLoggedInEvent) {
            PlayerEvent.PlayerLoggedInEvent loginEvent = (PlayerEvent.PlayerLoggedInEvent) event;
            Player player = loginEvent.getEntity();
    ...
    private static void sendDiscordWebhook(String playerName) {
        try {
            ...
            embedObject.addProperty("description", "**" + playerName + "** entrou no servidor");
