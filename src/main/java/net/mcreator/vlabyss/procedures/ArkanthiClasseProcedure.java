			...
			for (Entity entityiterator : EntityArgument.getEntities(arguments, "entity")) {
				if (BoolArgumentType.getBool(arguments, "value") == true) {
					...
					if (!(((LivingEntity) entityiterator).getAttribute(VlAbyssModAttributes.INTELIGENCIA.get())
							.hasModifier((new AttributeModifier(UUID.fromString("ea023ef8-c573-4b68-bdd7-ac8a9c4ad53f"), "arkanthi_int", 1, AttributeModifier.Operation.ADDITION)))))
					...
					((LivingEntity) entityiterator).getAttribute(VlAbyssModAttributes.INTELIGENCIA.get())
							.removePermanentModifier((new AttributeModifier(UUID.fromString("ea023ef8-c573-4b68-bdd7-ac8a9c4ad53f"), "arkanthi_int", 1, AttributeModifier.Operation.ADDITION)).getId());
				}
			}
