...
public class CavaleiroAladoEntity extends Monster implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(CavaleiroAladoEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(CavaleiroAladoEntity.class, EntityDataSerializers.STRING);
	...
	public CavaleiroAladoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(VlAbyssModEntities.CAVALEIRO_ALADO.get(), world);
	}

	public CavaleiroAladoEntity(EntityType<CavaleiroAladoEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("vl_abyss:invocacao_finalizada"));
	}
	...
	public void readAdditionalSaveData(CompoundTag compound) {
		...
		if (compound.contains("Dataataquechao"))
	...
	public void baseTick() {
		super.baseTick();
		CavaleiroAladoOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			...
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.model.standing"));
		}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CavaleiroAladoEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
