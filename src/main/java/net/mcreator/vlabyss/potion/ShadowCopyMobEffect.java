...
import net.mcreator.vlabyss.procedures.ShadowCopyEffectStartedappliedProcedure;
import net.mcreator.vlabyss.procedures.ShadowCopyEffectExpiresProcedure;
...
public class ShadowCopyMobEffect extends MobEffect {
	...
	public void removeAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		...
		ShadowCopyEffectExpiresProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity);
	}
